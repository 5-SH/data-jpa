...
class MemberRepositoryTest {
    ...
    @Test
    public void basicCRUD() throws InterruptedException {
...
//        List<Member> page = memberRepository.findByAge(age, pageRequest);
        ...
        for (MemberDto memberDto : toMap.getContent()) {
    ...
    public void bulkUpdate() {
        ...
        memberRepository.save(new Member("member1", 10, team));
        memberRepository.save(new Member("member2", 19, team));
        memberRepository.save(new Member("member3", 20, team));
        memberRepository.save(new Member("member4", 21, team));
        memberRepository.save(new Member("member5", 40, team));

        int resultCount = memberRepository.bulkAgePlus(20);
//        em.flush();
//        em.clear(); // @Modifying(clearAutomatically = true)에서 대신 실행
